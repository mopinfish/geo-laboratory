...
| `p07_three_scales.png` | 生成元: 同スクリプトの `make_p07_three_scales()`（入力: `choba_lake_3.jpg`・`aerial_quarry_pond.jpg`・公開GeoJSON＋`basemap_kitagi_carto_positron.png`。英語ラベルのみの発表専用合成図） | `5609587bdc434e1ad6fb1d213f57acc2ada447790df9ebd2979b3d25bab346c7` | S7 |
| `p08_visit_anchors_map.png` | 生成元: 同スクリプトの `make_p08_visit_anchors_map()`（入力: 公開GeoJSON＋訪問記図4の座標確認済み4地点＋`basemap_kitagi_carto_positron.png`） | `5b19c29e16ad7226d238cf8a0050a9644e335efe684b06d471e69dc5333eb336` | S8 |
