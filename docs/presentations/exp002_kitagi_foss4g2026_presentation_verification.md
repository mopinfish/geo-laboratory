...
|---|---:|---:|---:|---:|---:|
| 1 | 0:35 | 85 | 96 | 39.7秒 | +12.9% |
| 2 | 1:40 | 242 | 229 | 94.8秒 | −5.4% |
| 3 | 1:30（3–4で3:00） | 218 | 219 | 90.6秒 | +0.5% |
| 4 | 1:30（3–4で3:00） | 218 | 220 | 91.0秒 | +0.9% |
| 5 | 1:50 | 266 | 309 | 127.9秒 | +16.2% |
| 6 | 2:30 | 362 | 354 | 146.5秒 | −2.2% |
| 7 | 1:10 | 169 | 162 | 67.0秒 | −4.1% |
| 8 | 1:30 | 218 | 261 | 108.0秒 | +19.7% |
| 9 | 1:50 | 266 | 277 | 114.6秒 | +4.1% |
| 10 | 1:20 | 193 | 181 | 74.9秒 | −6.2% |
| 11 | 1:10（11–12で2:05） | 169 | 146 | 60.4秒 | −13.6% |
| 12 | 0:55（11–12で2:05） | 133 | 129 | 53.4秒 | −3.0% |
| **合計** | **17:30（1,050秒）** | **2,539** | **2,583** | **1,068.8秒（17:48）** | **+1.7%** |

いずれのスライドも検査スクリプトの許容幅（割当語数の±25%）以内であり、`validate_...py` は「OK: 949 checks passed」で通過している（6.4節）。**S6単体は算出354語・146.5秒（2:26）で、ハードゲートの2:30（150秒）に対して3.5秒の余裕がある。** 全体の算出合計17:48は目標17:30に対して+19秒（+1.8%）で、20分枠（質疑5分・入替5分を除く発表20分）に対しては十分な余裕がある。
