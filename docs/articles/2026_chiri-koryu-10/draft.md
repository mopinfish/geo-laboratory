...
北木島の存在は、訪問の少し前にX（旧Twitter）で偶然見かけた告知で知った。写真に写っていた岩壁が、整いすぎていて見たことのない景観だった。実物を見ねばと思い、単独で島まで足を運んだ次第である。

訪問の動機は、2026年3月20-21日に開催された「北木島ドローン・マッピングパーティ 2026」というイベントへの参加だった。ドローンで島内を3D計測し、その成果を OpenStreetMap（以下OSM）の地図に反映させていく、というワークショップである。

ところが、訪問のあとにもうひとつ視点が増えた。帰りの新幹線で、ふと思いついたのだ。衛星画像から水域を抽出する処理を使えば、島内の丁場跡の池をまとめて検出できるのではないか。降車前にざっと実装してみると、北木島の島内に145個もの水域が見えた。私が現地で歩いて目にした丁場は、せいぜい10個に満たない。
...
> 図1: 北木島の位置図（笠岡諸島と日本遺産構成資産）<br>
> 〔地理院淡色地図ベースで新規作成、出典: 地理院タイルを加工して作成〕

## Ⅰ　徒歩スケール — 桂林の岩壁の前で

### １．港から島内へ

笠岡駅から伏越港までは徒歩、そこから島まではフェリーで渡る。曇り空だったが、寒くはない、過ごしやすい3月の朝だった。海はエメラルドグリーンで、笠岡諸島の島影が霞んで見える。乗船する人々の足取りは軽やかで、誰もが乗り慣れた様子だった。私のような一見の旅行者にはやや足取りが及ばない。
...
港から「北木の桂林」までは車で送ってもらった。10分ほどの道のりである。

### ２．桂林に立つ

そして冒頭の岩壁である。

「桂林」とは旧今岡石材の丁場跡を指す通称で、切り出された花崗岩の岩壁に囲まれた池である。岩肌はツルツルとしていて、節理ではなく、明らかに切削された跡が残る。直線と直角が支配する、人工の渓谷である。水面の色は深い緑で、池は見るからに深い。
...
桂林の池には、奇妙な構造物がある。木製の小さなステージと、それに向かって並べられた、座席代わりの石である。ステージは水面の上に浮かんでいて、岸からはドラム缶を並べただけの即席の橋で渡る。歩くたびに揺れて、これがなかなか怖い。

桂林は時に湖上イベントの会場として使われるという。ステージに腰を下ろして眺めると、観客席に並ぶ石の背後に、岩壁が屏風のように立ち上がっている。岩壁を背景にした野外劇場、ということになる。

参加者の何人かは、ここで上空にドローンを上げ、その映像をモニタで覗き込みながら声を上げていた。「すごい」「ここまで来てたか」。同じ場所に立ったまま、視点だけが空へ移っていく感覚。Ⅰ章の徒歩スケールの最後は、すでに次の縮尺への入口だった。

> 図2: 北木の桂林（旧今岡石材丁場跡）の岩壁<br>
> 図3: 湖上ステージとドラム缶橋<br>
> 図4: 当日の徒歩ルート（出典: YAMAP活動記録および地理院タイルを加工して作成）

## Ⅱ　ドローンスケール — 「肉眼で見えるもの」を超えて

### １．マッピングパーティという催し

ドローン・マッピングパーティの主旨は、ひとことで言えば「歩いては届かないところを地図にする」である。北木島の景観資源は2019年に日本遺産「知ってる!? 悠久の時が流れる石の島」の構成文化財に登録されている^3)^が、その多くは島の山中、人の徒歩経路から外れた場所に点在している。これをドローンで3D計測し、OSMにポイントやエリアとして反映していく――というのが、二日間にわたる作業の骨子だった。

実は同イベントは前年（2025年3月）にも一度開催されており、その時のレポートには「肉眼では把握不能な『丁場湖の全体景観』」「砕石事業者間の境界として残された、垂直の造形美」といった発見が報告されている^4)^。同じ場所を、上空から再度撮影しつつ、未登録のフィーチャをOSMに追加していくのが今回の趣旨である。私自身、OSMで地物を追加した経験は以前にも一度あった。ただし、対象地域に集まって集中的に編集を進めるハンズオン形式に参加するのは初めてだった。

参加者の一人は、OSMで地物を公開する作業を「世界デビュー」と呼んでいた。ローカルに留まっていたデータがWebの世界標準地図に乗ることで、それが世界中の地図ユーザーに「見える」ようになる、ということである。

### ２．上空から見える境界線

ドローンが離陸する瞬間を、桂林の湖上ステージで目撃した。プロペラ音は思ったより静かで、機体は気がつくとずいぶん高いところまで上がっている。やがて操縦するスタッフのモニタには、湖を上から覗き込んだ画が映る。

最初に「おっ」と思ったのは、山の中にぽつりと現れる丁場の、人工的な歪感だった。緑の樹冠の中に、明らかに直線で切り取られたグレーの矩形が浮かび上がる。自然界では、こういう輪郭は普通できない。

さらに目を引いたのは、丁場と丁場の境界に立つ細いリッジ状の岩壁である。隣り合う採石事業者が、それぞれの掘削可能な範囲ぎりぎりまで石を切り出した結果、ふたつの丁場のあいだに、薄い壁だけが取り残されている。私はYAMAPの当日記録に、こう書き残している。「企業同士を境目として岸壁を形成していることが上空からは良くわかり、自然では形成され得ない産業遺産」。前回のレポート^4)^でも同様の指摘がなされている。所有境界が、ほとんど直接的に地形になっているのである。
...
イベント二日目には、宿泊先である小学校跡を改装したゲストハウスの集会所で、OSM編集のハンズオンが行われた。前日の現地踏査で得た情報を元に、丁場の輪郭、湖上ステージ、徒歩でアプローチ可能な小径などを地物として追加していく。地味な作業だが、編集を保存して地図上に反映されるのを見ると、たしかにこれは「世界デビュー」と呼べる行為である。

> 図5: 湖上ステージから離陸するドローン<br>
> 図6: 上空からの丁場群（事業者間の境界が細いリッジとして立ち現れている）

## Ⅲ　衛星スケール — 145の池が島の何を語るのか

### １．思いつきと、新幹線での実装

帰りの新幹線で、衛星画像のことを思い出したのは、Ⅱ章で見た「境界としての岸壁」をもっと広い範囲で確かめたかったからだった。ドローンは見たい場所を狙って飛ばすが、衛星は無差別に島全体を一度で撮影してくれる。私は別の業務で、Sentinel-2衛星の画像から水域を抽出する処理を扱った経験があり、これが丁場跡の池の検出にそのまま使えそうだ、と気がついた。

岡山に戻ってから手を動かす予定だったが、新幹線の中で開発環境を整え、解析を回し始めてしまった。Microsoft Planetary Computer から Sentinel-2 L2A プロダクト（雲量0.7%、2025年8月撮影）を取得し、Green/NIR/SWIRバンドからNDWIとMNDWI、NDVIを計算する。水域指数の理屈は単純で、水は近赤外光を強く吸収する一方で可視光の緑を反射するため、(Green − NIR)/(Green + NIR) という割り算をすると水域だけ正の値になる^5)^。植生や裸地はこの値が負になる。NIR を SWIR に置き換えた MNDWI を併用すると、岩肌と水の分離がさらに改善することが知られている^6)^。
...
> 図7: 水域指数の空間分布（NDWI/MNDWI/NDVI/最終マスク）<br>
> 図8: 検出された島内水域145件の分布図<br>
> 〔図7・図8: Microsoft Planetary Computer, Sentinel-2 L2A データを処理して作成〕

### ３．歩いた丁場と、見ていない丁場

イベント中に徒歩や車で訪れた丁場は、実数えてみても、せいぜい5〜6か所ほどである。地ノ浜（島民から「北木島のベニス」とも呼ばれる、石材で護岸された海岸）も訪れたが、これは丁場ではない。要するに、私が現地で五感で確かめたのは、衛星から見える145件の水域のうちの、5%にも満たない。

これはかなり面白い数字である。徒歩・ドローン・衛星の三段の縮尺は、それぞれ撮影できる「面積」がまるで違う。徒歩で立てるのは丁場の前と、湖上ステージの上だけ。ドローンは半径数百mの空間を一気に俯瞰してくれる。衛星は島全体を一度で覆う。それぞれのスケールが、それぞれ別の問いに答えてくれる。徒歩は質感を、ドローンは境界の論理を、衛星は分布のパターンを、それぞれ可視化する。

訪問前に、もし衛星解析の結果を先に見ていたら、私はおそらく「数」のほうに気を取られて、現場で岩壁を見上げた感覚を持ち帰ってこなかっただろう。逆に、徒歩とドローンの体験だけで終わっていたら、北木島の丁場群の全容は見えないままだった。順序のおかげで、三つの縮尺がうまく重なってくれた、ということなのだと思う。

> 図9: 同一箇所を徒歩・ドローン・衛星の三スケールで重ねた図<br>
> 〔新規制作: 衛星画像と現地写真・上空写真を縮尺合わせて並置〕
