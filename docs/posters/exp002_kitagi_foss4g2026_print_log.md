...
**ポスター印刷の発注を保留する。** 公式スケジュールの確認により、本採択が口頭発表（`General session talk`、9/2 13:30–14:00、Himawari、30分）として登録されており、ポスター発表であるかが未確定になったため。詳細と根拠は `exp002_kitagi_foss4g2026_proposal.md` の「発表形式の未確定事項（2026-08-23 追記）」を参照。

主催者から発表形式の回答を得てから、下記の確認項目に進む。
